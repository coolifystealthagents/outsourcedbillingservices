...
const researchAug18Body = (question: string, scope: string, evidence: string, finding: string, role: string, comparison: string, comparisonTwo: string, limits: string, conclusion: string, sources: string[]) => [
