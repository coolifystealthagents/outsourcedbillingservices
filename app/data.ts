...
const aug13BlogSeeds: Aug13ReplacementSeed[] = [
  {slug:'philippines-medical-billing-charge-split-review',title:'Philippines medical billing charge split review',excerpt:'How to compare split charges to source records and route unresolved allocation questions.',focus:'charge split review',service:'billing-data-quality-review',related:['charge-entry-review-checklist','billing-reconciliation','source-record-reconciliation-check'],published:'2026-08-13'},
  {slug:'philippines-medical-billing-payer-enrollment-change-handoff',title:'Philippines medical billing payer enrollment change handoff',excerpt:'A source-led handoff for enrollment changes, effective dates, and billing owner review.',focus:'payer enrollment change handoff',service:'billing-data-quality-review',related:['eligibility-verification-checklist','contract-terms-billing-handoff','owner-review-packet-design'],published:'2026-08-13'},
  {slug:'philippines-medical-billing-medical-record-request-tracker',title:'Philippines medical billing medical record request tracker',excerpt:'A tracker for requested records, due dates, source locations, and accountable follow-up.',focus:'medical record request tracking',service:'collections-follow-up',related:['documentation-follow-up-checklist','appeal-packet-preparation','claim-attachment-checklist'],published:'2026-08-13'},
  {slug:'philippines-medical-billing-coordination-of-benefits-review',title:'Philippines medical billing coordination of benefits review',excerpt:'A practical comparison for payer order evidence, conflicts, and owner decisions.',focus:'coordination of benefits review',service:'billing-data-quality-review',related:['eligibility-verification-checklist','patient-demographic-verification-checklist','claim-submission-checklist'],published:'2026-08-13'},
  {slug:'philippines-medical-billing-authorization-expiry-follow-up',title:'Philippines medical billing authorization expiry follow-up',excerpt:'A follow-up queue for authorization end dates, evidence gaps, and timely escalation.',focus:'authorization expiry follow-up',service:'collections-follow-up',related:['prior-authorization-tracker','claim-status-follow-up-checklist','documentation-follow-up-checklist'],published:'2026-08-13'},
  {slug:'philippines-medical-billing-corrected-claim-resubmission-log',title:'Philippines medical billing corrected claim resubmission log',excerpt:'A log for correction evidence, resubmission references, responses, and next actions.',focus:'corrected claim resubmission logging',service:'billing-data-quality-review',related:['claim-correction-checklist','claim-status-follow-up-checklist','payer-message-index'],published:'2026-08-13'},
  {slug:'philippines-medical-billing-remit-adjustment-reason-review',title:'Philippines medical billing remit adjustment reason review',excerpt:'A review method for adjustment reasons, remittance lines, and unresolved balance questions.',focus:'remittance adjustment reason review',service:'payment-posting',related:['remittance-review-checklist','payment-posting-exception-checklist','reconciliation-difference-log'],published:'2026-08-13'},
  {slug:'philippines-medical-billing-patient-identity-mismatch-escalation',title:'Philippines medical billing patient identity mismatch escalation',excerpt:'How to document identity mismatches without making unsupported record changes.',focus:'patient identity mismatch escalation',service:'billing-data-quality-review',related:['patient-demographic-verification-checklist','eligibility-exception-log','claim-correction-checklist'],published:'2026-08-13'},
  {slug:'philippines-medical-billing-encounter-date-integrity-check',title:'Philippines medical billing encounter date integrity check',excerpt:'A date comparison routine for encounters, billing lines, source notes, and exceptions.',focus:'encounter date integrity checking',service:'billing-data-quality-review',related:['charge-entry-review-checklist','claim-submission-checklist','source-record-reconciliation-check'],published:'2026-08-13'},
  {slug:'philippines-medical-billing-provider-enrollment-handoff',title:'Philippines medical billing provider enrollment handoff',excerpt:'A handoff structure for provider enrollment evidence and billing setup questions.',focus:'provider enrollment handoff',service:'outsourced-team-handoff-checklist',related:['payer-enrollment-change-handoff','eligibility-verification-checklist','owner-review-packet-design'],published:'2026-08-13'},
  {slug:'philippines-medical-billing-noncovered-service-question-routing',title:'Philippines medical billing noncovered service question routing',excerpt:'A bounded routing method for coverage questions, source evidence, and owner decisions.',focus:'noncovered service question routing',service:'customer-billing-support',related:['eligibility-exception-log','customer-invoice-question-log','dispute-documentation'],published:'2026-08-13'},
  {slug:'philippines-medical-billing-invoice-tax-field-review',title:'Philippines medical billing invoice tax field review',excerpt:'A source comparison for invoice tax fields, approved terms, and escalation boundaries.',focus:'invoice tax field review',service:'invoice-preparation',related:['invoice-line-source-check','contract-terms-billing-handoff','invoice-approval-routing'],published:'2026-08-13'},
  {slug:'philippines-medical-billing-recurring-invoice-cutoff-review',title:'Philippines medical billing recurring invoice cutoff review',excerpt:'A cutoff review for recurring invoices, effective changes, and owner release.',focus:'recurring invoice cutoff review',service:'subscription-billing-support',related:['subscription-change-review','invoice-approval-routing','billing-reconciliation'],published:'2026-08-13'},
  {slug:'philippines-medical-billing-unapplied-remittance-resolution',title:'Philippines medical billing unapplied remittance resolution',excerpt:'A traceable process for unapplied remittances, candidate matches, and safe escalation.',focus:'unapplied remittance resolution',service:'billing-reconciliation',related:['unapplied-cash-review-checklist','remittance-to-claim-match','payment-posting-exception-checklist'],published:'2026-08-13'},
  {slug:'philippines-medical-billing-balance-transfer-review',title:'Philippines medical billing balance transfer review',excerpt:'A source-led review for balance transfers that keeps approval and correction decisions visible.',focus:'balance transfer review',service:'billing-reconciliation',related:['credit-balance-review-checklist','billing-reconciliation','customer-invoice-question-log'],published:'2026-08-13'},
  {slug:'philippines-medical-billing-payment-batch-control-sheet',title:'Philippines medical billing payment batch control sheet',excerpt:'A control sheet for payment batches, totals, source references, and posting exceptions.',focus:'payment batch control',service:'payment-posting',related:['payment-posting-exception-checklist','remittance-review-checklist','billing-reconciliation'],published:'2026-08-13'},
  {slug:'philippines-medical-billing-denial-response-evidence-check',title:'Philippines medical billing denial response evidence check',excerpt:'A focused check for denial response evidence, deadlines, and accountable approval.',focus:'denial response evidence checking',service:'dispute-documentation',related:['denial-intake-checklist','appeal-packet-preparation','payer-message-index'],published:'2026-08-13'},
  {slug:'philippines-medical-billing-claim-status-contact-log',title:'Philippines medical billing claim status contact log',excerpt:'A contact log that preserves payer references, dates, responses, and next follow-up.',focus:'claim status contact logging',service:'collections-follow-up',related:['claim-status-follow-up-checklist','payer-message-index','denial-intake-checklist'],published:'2026-08-13'},
  {slug:'philippines-medical-billing-documentation-request-aging-review',title:'Philippines medical billing documentation request aging review',excerpt:'A review for aging documentation requests, deadline exposure, and next owners.',focus:'documentation request aging review',service:'collections-follow-up',related:['documentation-follow-up-checklist','queue-aging-escalation-checklist','claim-attachment-checklist'],published:'2026-08-13'},
  {slug:'philippines-medical-billing-billing-period-cutoff-control',title:'Philippines medical billing billing period cutoff control',excerpt:'A period cutoff control for source dates, unposted work, and reconciliation questions.',focus:'billing period cutoff control',service:'month-end-billing-support',related:['month-end-close-checklist','month-end-unposted-item-review','reconciliation-difference-log'],published:'2026-08-13'},
  {slug:'philippines-medical-billing-account-merger-review',title:'Philippines medical billing account merger review',excerpt:'A careful review for account merges, source identity evidence, and owner authorization.',focus:'account merger review',service:'billing-data-quality-review',related:['patient-demographic-verification-checklist','duplicate-charge-review','source-record-reconciliation-check'],published:'2026-08-13'},
  {slug:'philippines-medical-billing-exception-volume-review',title:'Philippines medical billing exception volume review',excerpt:'A weekly view of exception volume that separates observed queue facts from assumptions.',focus:'exception volume review',service:'billing-data-quality-review',related:['weekly-quality-sample-review','queue-rework-analysis','owner-escalation-summary-template'],published:'2026-08-13'},
];
...
const buildAug13BlogBatch = (seeds: Aug13ReplacementSeed[]) => seeds.map((seed, index) => {
  ...
  return { slug: `august-13-${seed.slug}`, title: seed.title, excerpt: seed.excerpt, minutes: 9 + (index % 6), detail: {
    keyword: seed.title, marker: `OBS-BLOG-20260813-${String(index + 1).padStart(2,'0')}`, published: seed.published, updated: seed.published,
