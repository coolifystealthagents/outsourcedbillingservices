...
researchPosts.push(...aug17ResearchDeficit, ...researchAug18Posts.slice(0, 10), ...researchAug17Posts, ...researchAug14Posts, ...researchAug13Posts, ...researchRunOrder.map((slug) => researchRunPosts.find((post) => post.slug === slug)!), ...researchBatchPosts, ...aug20Research);
