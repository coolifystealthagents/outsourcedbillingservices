...
export const researchPosts: Array<{ slug: string; title: string; excerpt: string; body: string[]; published?: string; updated?: string; featuredImage?: string; serviceCta?: { href: string; label: string; title: string; body: string } }> = [
