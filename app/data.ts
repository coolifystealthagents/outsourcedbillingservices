...
const buildAug13BlogBatch = (seeds: Array<DailyBlogSeed & { published: '2026-08-13' | '2026-08-14' }>, batchTag: '20260813' | '20260814' = '20260813') => seeds.map((seed, index) => {
...
researchPosts.push(...researchAug14Posts, ...researchAug13Posts, ...researchAug11Posts, ...researchRunOrder.map((slug) => researchRunPosts.find((post) => post.slug === slug)!), ...researchBatchPosts);
