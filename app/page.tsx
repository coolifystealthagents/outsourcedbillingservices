    ...
    <section className="hero-shell">
      ...
      <div className="hero-grid">
        <div className="hero-copy">
          <p className="eyebrow">Billing claims board</p>
          <h1>Outsourced Billing Services: a revenue cycle board for clearer staffing decisions.</h1>
          <p className="lead">A redesigned outsourced billing services guide for medical, service, and B2B teams outsourcing billing admin. The page now uses a distinct medical-adjacent board layout, industry-specific planning sections, and a conversion path that feels made for this niche.</p>
        ...
        <figure className="hero-media"><img src={site.heroImage || site.serviceImage} alt={site.alt || `${site.brand} planning visual`}/><figcaption>claim cards and audit trails</figcaption></figure>
      </div>
    </section>
