...
const acceptedResearchRank = new Map([
  ['research-medical-billing-aug13-authorization-evidence', 0],
  ['research-medical-billing-aug13-charge-to-encounter-reconciliation', 1],
  ['research-medical-billing-aug13-claim-acknowledgment-traceability', 2],
  ['research-medical-billing-aug13-denial-cause-cohort-analysis', 3],
  ['research-medical-billing-aug13-document-request-aging', 4],
  ['research-medical-billing-aug13-patient-balance-explanation-review', 5],
  ['research-medical-billing-aug13-payer-enrollment-evidence', 6],
  ['research-medical-billing-aug13-prior-authorization-status-research', 7],
  ['research-medical-billing-aug13-rejection-pattern-segmentation', 8],
  ['research-medical-billing-aug13-unbilled-encounter-completeness', 9],
