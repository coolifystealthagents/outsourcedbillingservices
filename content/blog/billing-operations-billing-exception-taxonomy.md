---
title: Billing Operations: Billing Exception Taxonomy
date: 2026-08-20
---
# Billing Operations: Billing Exception Taxonomy
*August 20, 2026*

A billing exception taxonomy gives each problem a name that points toward the right evidence and owner. It should not be a long list that hides judgment. Define terms in plain language and state which role may assign or change each category.

## Separate kinds of work

Source exceptions include missing records, conflicting identifiers, inaccessible systems, malformed files, and duplicate candidates. Decision exceptions include coding, coverage, contract interpretation, write-off, refund, release, and policy choices. Mixing them causes staff to treat a missing document as a business answer.

Each category needs entry condition, required evidence, prohibited shortcut, owner, and exit state. “Access blocked” should identify system, search path, date, and approved route. It should not be closed as “missing document” because the assigned role cannot view the source. “Coding review required” is safer than “coding error” before qualified review.

Review category drift and unexplained “other” use. Preserve prior category after reopening. Report opening population, category counts, exclusions, unknowns, and definition changes before comparing periods. The goal is an honest map from evidence condition to accountable decision.

### Control points

- Define entry and exit conditions.
- Separate source gaps from decisions.
- Require evidence and a bounded question.
- Keep authority visible in labels.
- Minimize unexplained “other.”
- Preserve category history.
- Explain taxonomy revisions.
## Operating notes
